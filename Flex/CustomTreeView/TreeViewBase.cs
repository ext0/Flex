...
namespace Flex.CustomTreeView
{
    ...
    public abstract partial class TreeViewBase<T> : UserControl where T : INotifyPropertyChanged
    {
        ...
        private Dictionary<T, TreeViewItem> treeViewItems;
        /// <summary>
        ...
        public TreeViewBase()
        {
            ...
            treeViewItems = new Dictionary<T, TreeViewItem>();
        }
        ...
        protected virtual void OnNodeExpanded(TreeViewItem treeNode)
        {
            ...
            T item = (T)(treeNode.Header as INotifyPropertyChanged);
            if (item == null) return;
        ...
        private void RenderTree(IEnumerable<T> items, TreeLayout layout)
        {
            ...
            if (selectedNode == null) SelectedItem = default(T);
        ...
        private void RegisterPropertyListener(T item, TreeViewItem treeViewItem)
        {
            treeViewItems[item] = treeViewItem;
            item.PropertyChanged += PropertyListenerChanged;
        }

        private void PropertyListenerChanged(Object sender, PropertyChangedEventArgs e)
        {
            T item = (T)sender;
            if (treeViewItems.ContainsKey(item))
            {
                TreeViewItem treeViewItem = treeViewItems[item];
                treeViewItem.Style = null;
                treeViewItem.Style = TreeNodeStyle;
            }
        }
        ...
        protected internal void CreateItemNode(T item, IList parentNodes, TreeLayout layout)
        {
            ...
            RegisterPropertyListener(item, treeNode);
            ...
            if (hasLayout && itemKey.Equals(layout.SelectedItemId) || item.Equals(SelectedItem))
            {
        ...
        protected internal TreeViewItem TryFindItemNode(ItemCollection treeNodes, string itemKey, bool recurse)
        {
            ...
            {
                T nodeItem = (T)(treeNode.Header as INotifyPropertyChanged);
                if (nodeItem != null)
                {
        ...
        private void OnSelectedItemChanged(object sender, RoutedPropertyChangedEventArgs<object> e)
        {
            ...
            if (e.NewValue != null)
            {
                ...
                T item = (T)(node.Header as INotifyPropertyChanged);
        ...
        public virtual bool IsChildOf(T child, T parent)
        {
            ...
            if (directParent == null)
                return false;
            else if (directParent.Equals(parent))
                return true;
            else
